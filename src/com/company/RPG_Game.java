...
public class RPG_Game {
    ...
    public static void start() {
        ...
        Boss boss = new Boss(800, 50, "Tanos");
        Warrior warrior = new Warrior(250, 20, "Warrior1");
        Medic doc = new Medic(220, 0, 15, "Doc");
        Magic magic = new Magic(240, 15, "Magic1");
        Berserk berserk = new Berserk(250, 10, "Berserk1");
        Medic assistant = new Medic(245, 5, 5, "DocHelper");
